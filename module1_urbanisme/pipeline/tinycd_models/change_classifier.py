...
import torchvision
from module1_urbanisme.pipeline.tinycd_models.layers import MixingMaskAttentionBlock, PixelwiseLinear, UpMask, MixingBlock
...
def _get_backbone(
    ...
    # The whole model (Utilisation de la nouvelle syntaxe 'weights' pour éviter les avertissements PyTorch):
    kwargs = {"weights": "DEFAULT"} if pretrained else {"weights": None}
